...
rule : 10253 100 {((0,0) < 10000) and ( #macro(C) > 0) and (#macro(temperature) < CToK(1*( #macro(C)*(1 - #macro(C))) ))}	
% Heat Conduction
...
[insulatingTop-rule]
rule : 10253 100 {((0,0) < 10000) and ( #macro(CTop) > 0) and (#macro(temperature) < CToK(1*( #macro(CTop)*(1 - #macro(CTop))) ))}	
% Heat Conduction
...
rule : 10253 100 {((0,0) < 10000) and ( #macro(CBottom) > 0) and (#macro(temperature) < CToK(1*( #macro(CBottom)*(1 - #macro(CBottom))) ))}	
% Heat Conduction
