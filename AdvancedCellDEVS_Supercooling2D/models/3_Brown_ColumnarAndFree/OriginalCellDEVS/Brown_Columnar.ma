...
initialvalue : 237
initialCellsValue : supercooling2DColumnar.val
localtransition : supercooling2D-rule

[supercooling2D-rule]
% Solidification and Heat Realease
rule : 10273 100 {((0,0) < 10000) and ( #macro(C) = 2) and (#macro(temperature) < CToK(30*( #macro(C)*(1 - #macro(C))) ))}	
% Heat Conduction
...
[insulatingTop-rule]
rule : 10273 100 {((0,0) < 10000) and ( #macro(CTop) = 2) and (#macro(temperature) < CToK(30*( #macro(CTop)*(1 - #macro(CTop))) ))}	
% Heat Conduction
...
rule : 10273 100 {((0,0) < 10000) and ( #macro(CBottom) = 2) and (#macro(temperature) < CToK(30*( #macro(CBottom)*(1 - #macro(CBottom))) ))}	
% Heat Conduction
